...
canv.create_line(462, 10, 462, 689, width=2, fill='white', tags='g2')  

canv.create_line(2, 11, 463, 11, width=10, fill='white', tag=('wall', 'y'))  
canv.create_line(2, 689, 463, 689, width=10, fill='white', tag=('wall', 'y'))       
